...
if uploaded_file1 and uploaded_file2:
    try:
        ...
        start_idx2 = np.searchsorted(time2, start_threshold, side='left')
        ...
        if score_global1 > score_global2:
            ...
            comparison_result="Signal 1 présente un meilleur compromis entre SNR élevé, faible distorsion (THD) et bruit réduit, selon le score combiné."
        elif score_global2 > score_global1:
            best_signal="Signal 2"
            comparison_result="Signal 2 présente un meilleur compromis entre SNR élevé, faible distorsion (THD) et bruit réduit, selon le score combiné."
        else:
            best_signal="Égalité"
            comparison_result="Les deux signaux ont des performances comparables en termes de qualité globale (SNR, THD, bruit et amplitude fondamentale)."
